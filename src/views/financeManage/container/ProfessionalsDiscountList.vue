<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column
        prop=""
        label="售额3k专员提成[无保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额5k专员提成[无保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额10k专员提成[无保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额20k专员提成[无保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额50k专员提成[无保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额3k专员提成[有保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额5k专员提成[有保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额10k专员提成[有保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额20k专员提成[有保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        prop=""
        label="售额50k专员提成[有保底]（%）酒劵/现金">
      </el-table-column>
      <el-table-column
        label="操作"
        width="60">
